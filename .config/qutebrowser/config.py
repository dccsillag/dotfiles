...
c.colors.tabs.bar.bg                            = '#555558'
c.colors.tabs.even.fg                           = '#ffffff'
c.colors.tabs.even.bg                           = '#555558'
c.colors.tabs.odd.fg                            = '#ffffff'
c.colors.tabs.odd.bg                            = '#555558'
