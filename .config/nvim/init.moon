...
do
    ...
    --- Setup folding
    vim.o.foldminlines = 10 -- require at least 10 lines of content to create a fold
...
do
    ...
    vim.cmd "autocmd BufWritePost #{vim.fn.expand('~/.config/nvim/init.moon')} AsyncRun moonc %"
